  ...
  return (
    <>
      ...
      <Slide direction="up" in={open} mountOnEnter unmountOnExit>
        ...
        >
          {/* HEADER */}
          <Box sx={{ bgcolor: 'success.main', color: 'white', p: 1.5, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <Typography variant="subtitle1" fontWeight="bold">SolidarIA Chat</Typography>
